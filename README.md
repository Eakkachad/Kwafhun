...
3. **Plan** — RAG AI สร้าง "1-Page Dream Roadmap" ส่วนบุคคล จากข้อมูลจริง (สพฐ. + กสศ. + AIS LearnDi + TCAS)
...
- **ระบบคัดกรอง (Screening):** ก่อนเข้าร่วมกิจกรรม/ค่าย ต้องเรียนคอร์สพื้นฐาน + ทำแบบวัดความสนใจก่อน → คัดเฉพาะเด็กที่สนใจจริง (ประหยัดงบ ไม่จ่ายเปล่า)
...
Discover (Netflix of Dreams) ─► Learn (Coursera-style คอร์ส + Gamification)
      └─► Screening: คัดเด็กที่สนใจจริง (เรียนคอร์สพื้นฐานก่อนเข้าร่วม)
