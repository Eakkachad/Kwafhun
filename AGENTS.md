...
5. **ตัวเลขมหภาค = บริบทของปัญหาเท่านั้น** — 3.3 ล้านล้านบาท / shortage 300,000 คน / Q1 +15–20% ใช้เล่า "ขนาดปัญหา" ไม่ใช่ "ผลลัพธ์ที่เราวัดได้"
6. **ระบบต้องไม่สร้างความเหลื่อมล้ำซ้ำ** — ฟีเจอร์ที่วัด "ความสนใจ/คะแนน" ต้องเกิดขึ้นในคาบเรียน (ทุกคนเท่ากัน) ไม่ใช่ให้เด็กแข่งทรัพยากรที่บ้าน
7. **ข้อมูลเด็ก = Two-Tier เสมอ** — ชั้นวิเคราะห์ใช้ Anonymous ID, ชั้นรายงาน สพฐ. ต้องมี Consent ผู้ปกครอง และมีมาตรการคุ้มครองเด็ก (Mentor Vetting, monitor)
